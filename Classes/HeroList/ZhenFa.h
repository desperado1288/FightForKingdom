#ifndef __ZHENFA_LAYER_H__
#define __ZHENFA_LAYER_H__

#include "cocos2d.h"
//#include "LayerManager/MainScene.h"
using namespace std;

const int FRAME_TAG = 50;
const int FRAME_MENU_TAG = 49;
const int HERO_TAG = 60;
const int HERO_MENU_TAG =59;
class ZhenFa : public cocos2d::Layer
{
public:
